...
function Chats() {
    return (
        <div className="flex-1 flex flex-col justify-center items-center border rounded-lg bg-zinc-100">
            ...
            {/* Chat Header */}
            {/* <div className="h-[5rem] flex items-center gap-3 px-5 border rounded-t-lg border-gray-200 bg-white shadow-sm">
            ...
            {/* Input */}
            {/* <div className="h-[4.5rem] px-5 flex items-center border-t border-gray-200 bg-white">
                        <input
                            type="text"
                            placeholder="Type a message..."
                            className="flex-1 bg-gray-100 text-gray-800 px-4 py-2 rounded-full outline-none placeholder-gray-400"
                        />
